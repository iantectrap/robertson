...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post homes_url, params: { home: { about: @home.about, contact: @home.contact, courses: @home.courses } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { about: @home.about, contact: @home.contact, courses: @home.courses } }
